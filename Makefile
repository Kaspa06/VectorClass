...
main.o: main.cpp containers.h funkcijos.h testRules.h vector.h
    $(CXX) $(CXXFLAGS) -c main.cpp

containers.o: containers.cpp containers.h funkcijos.h funkcijosVECTOR.h studentas.h testRules.h vector.h
    $(CXX) $(CXXFLAGS) -c containers.cpp

funkcijos.o: funkcijos.cpp funkcijos.h studentas.h testRules.h vector.h
    $(CXX) $(CXXFLAGS) -c funkcijos.cpp

funkcijosVECTOR.o: funkcijosVECTOR.cpp funkcijosVECTOR.h studentas.h testRules.h vector.h
    $(CXX) $(CXXFLAGS) -c funkcijosVECTOR.cpp

studentas.o: studentas.cpp studentas.h testRules.h vector.h
    $(CXX) $(CXXFLAGS) -c studentas.cpp

testRules.o: testRules.cpp testRules.h vector.h
    $(CXX) $(CXXFLAGS) -c testRules.cpp

VectorTest.o: VectorTest.cpp VectorTest.h vector.h
